						...
						<div class="block-flat">
							...
							<div class="content">
								<form class="form-horizontal group-border-dashed"
									action="<c:url value="/board/${bbsId}/insert"/>"
										...
										<div class="col-sm-6">
											<div class="fileinput fileinput-new"
												...
												<span class="btn btn-primary btn-file"><span
													class="fileinput-new">파일</span><span
													class="fileinput-exists">파일추가</span>
													<input type="file"
													name="atchFileIdFile"></span> <span class="fileinput-filename"></span>
...
-------------------------------------------------------------------------------->
	...
	<script type="text/javascript">
		...
		var sendFile = function sendFile(file, editor, welEditable) {
